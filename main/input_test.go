...
func TestInputString(t *testing.T) {
	...
	if text != "{nbCreatures:2, creatures:map[1:{id:1, color:1, type:1, coords:, scannedBy:[]} 2:{id:2, color:2, type:2, coords:, scannedBy:[]}], player:{score:5, drones:map[3:{id:3, x:3, y:3, emergency:3, battery:3} 4:{id:4, x:4, y:4, emergency:4, battery:4}]}, foe:{score:10, drones:map[5:{id:5, x:5, y:5, emergency:5, battery:5}]}}" {
